...
function createProjectCard(project){
    ...
    return `
        <div class="project-main-card" 
            ...
            --secondary:${color2};
        ">
            <div class="spin-card spin-card-blur"></div>
            <div class="spin-card spin-card-intense"></div>
            <div class="backdrop"></div>
            <div class="spin-card spin-card-inside"></div>
            ...
            <div class="main-content">
                ...
                <div class="project-content">
                    ...
                    <div class="project-expand">
                        <button class="btn github-preview-btn">
                            <div class="btn-left">
                                ${githubIcon()}
                                <span>GitHub</span>
                            </div>
                        ...
                        <div class="project-expand-content">
                            ...
                            <div class="project-buttons">
                                <a href="${project.github}" target="_blank" class="btn btn-github-main">
                                    ${githubIcon()}
                                    <span>GitHub</span>
                                </a>
...
document.addEventListener("click", function (e) {
    const button = e.target.closest(".github-preview-btn");

    if (!button) return;

    const projectExpand = button.closest(".project-expand");
    projectExpand.classList.toggle("active");
});
